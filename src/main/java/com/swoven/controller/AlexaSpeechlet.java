...
public class AlexaSpeechlet implements SpeechletV2 {
    ...
    public SpeechletResponse onIntent(SpeechletRequestEnvelope<IntentRequest> requestEnvelope) {
        ...
        if ("FindMyWife".equals(intentName)) {
    ...
    private SpeechletResponse getHelloResponse() {
        String speechText = "Manita Shrestha is your wife, please love her. ";
    ...
    private SpeechletResponse getHelpResponse() {
        String speechText = "I can help you find your wife!";
        return getAskResponse("HelloWorld", speechText);
    }
